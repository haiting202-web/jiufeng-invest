---
name: buyer-list
description: 战略买家和财务买家名单，用于M&A交易。触发词：潜在买家名单、Buyer List、买家、M&A、交易。当用户需要潜在买家名单相关分析时使用。
agent_created: true
version: 2.0.0
...
请提供您要分析的标的信息（如股票代码、行业名称、财务数据或相关文件），我将为您战略买家和财务买家名单，用于M&A交易。
```
