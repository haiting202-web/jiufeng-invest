---
name: client-report
description: 客户持仓报告和资产配置分析，包括业绩归因、风险分析。触发词：客户资产报告、Client Report、客户、持仓、报告。当用户需要客户资产报告相关分析时使用。
agent_created: true
version: 2.0.0
...
# 客户资产报告（Client Report）

> 分类：财富管理 | 技能 id：`client-report`
...
请提供您要分析的标的信息（如股票代码、行业名称、财务数据或相关文件），我将为您客户持仓报告和资产配置分析，包括业绩归因、风险分析。
```
