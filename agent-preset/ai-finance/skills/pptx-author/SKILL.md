---
name: pptx-author
description: 生成专业格式的PowerPoint演示文稿，支持图表和动画。触发词：PPT报告制作、PPT Author、PPT、演示、报告。当用户需要PPT报告制作相关分析时使用。
agent_created: true
version: 2.0.0
...
请提供您要分析的标的信息（如股票代码、行业名称、财务数据或相关文件），我将为您生成专业格式的PowerPoint演示文稿，支持图表和动画。
```
