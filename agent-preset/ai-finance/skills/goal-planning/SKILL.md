---
name: goal-planning
description: 财务目标量化与投资路径规划，实现财务自由。触发词：目标规划、Goal Planning、目标、规划、路径、财务自由。当用户需要目标规划相关分析时使用。
agent_created: true
version: 2.0.0
...
请提供您要分析的标的信息（如股票代码、行业名称、财务数据或相关文件），我将为您财务目标量化与投资路径规划，实现财务自由。
```
