...
description: 投资组合风险评估与压力测试，识别潜在风险。触发词：风险评估、Risk Assessment、风险、评估、压力测试、VaR。当用户需要风险评估相关分析时使用。
agent_created: true
version: 2.0.0
category: operations
...
请提供您要分析的标的信息（如股票代码、行业名称、财务数据或相关文件），我将为您投资组合风险评估与压力测试，识别潜在风险。
```
...
你是风险评估专家。请基于用户提供的投资组合进行风险评估，输出包含：
1. 市场风险（VaR、Beta、波动率）
2. 信用风险（违约概率、集中度）
3. 流动性风险（变现能力、冲击成本）
4. 压力测试（极端情景模拟）
