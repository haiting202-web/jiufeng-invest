...
description: 系统性股票筛选和投资主题挖掘，结合量化筛选和主题研究。触发词：投资机会挖掘、Idea Generation、投资、筛选、主题。当用户需要投资机会挖掘相关分析时使用。
agent_created: true
version: 2.0.0
...
# 投资机会挖掘（Idea Generation）

> 分类：权益研究 | 技能 id：`idea-generation`
...
请提供您要分析的标的信息（如股票代码、行业名称、财务数据或相关文件），我将为您系统性股票筛选和投资主题挖掘，结合量化筛选和主题研究。
```
