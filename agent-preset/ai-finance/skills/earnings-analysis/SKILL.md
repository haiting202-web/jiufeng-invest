...
description: 季度财报深度分析，拆解beat/miss原因、调整盈利预测、评估对投资逻辑的影响。触发词：财报分析、Earnings Analysis、财报、季度、分析。当用户需要财报分析相关分析时使用。
agent_created: true
version: 2.0.0
...
> 分类：权益研究 | 技能 id：`earnings-analysis`
...
请输入股票代码和财报期（如 2025Q1），我将拉取公告全文并深度解读财报。
```
