...
description: 财报发布前分析，构建预测模型、情景假设、需要关注的关键指标。触发词：财报前瞻、Earnings Preview、财报、前瞻、预期。当用户需要财报前瞻相关分析时使用。
agent_created: true
version: 2.0.0
...
> 分类：权益研究 | 技能 id：`earnings-preview`
...
请提供您要分析的标的信息（如股票代码、行业名称、财务数据或相关文件），我将为您财报发布前分析，构建预测模型、情景假设、需要关注的关键指标。
```
