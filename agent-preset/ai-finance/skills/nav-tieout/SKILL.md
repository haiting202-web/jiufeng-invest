---
name: nav-tieout
description: 基金NAV核对和验证，报表与净值包逐项比对。触发词：净值核对、NAV Tieout、NAV、核对、基金。当用户需要净值核对相关分析时使用。
agent_created: true
version: 2.0.0
category: fund-admin
...
请提供您要分析的标的信息（如股票代码、行业名称、财务数据或相关文件），我将为您基金NAV核对和验证，报表与净值包逐项比对。
```
