---
name: merger-model
description: 并购增厚/稀释分析，协同效应评估。触发词：并购模型、Merger Model、并购、M&A、模型。当用户需要并购模型相关分析时使用。
agent_created: true
version: 2.0.0
