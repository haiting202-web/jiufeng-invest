---
name: xlsx-author
description: 生成专业格式的Excel文件，支持公式、图表和条件格式。触发词：Excel报告制作、Excel Author、Excel、生成、报告。当用户需要Excel报告制作相关分析时使用。
agent_created: true
version: 2.0.0
...
# Excel报告制作（Excel Author）

> 分类：财务分析 | 技能 id：`xlsx-author`
...
请提供您要分析的标的信息（如股票代码、行业名称、财务数据或相关文件），我将为您生成专业格式的Excel文件，支持公式、图表和条件格式。
```
...
你是Excel报告专家。请说明如何制作专业的财务Excel报告。
