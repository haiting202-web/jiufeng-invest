---
name: process-letter
description: 交易流程函，指导买方参与竞拍的流程和要求。触发词：交易流程说明、Process Letter、流程、信函、竞拍。当用户需要交易流程说明相关分析时使用。
agent_created: true
version: 2.0.0
...
# 交易流程说明（Process Letter）

> 分类：投资银行 | 技能 id：`process-letter`
...
请提供您要分析的标的信息（如股票代码、行业名称、财务数据或相关文件），我将为您交易流程函，指导买方参与竞拍的流程和要求。
```
