---
name: dd-checklist
description: 尽职调查清单，确保关键领域全覆盖。触发词：尽职调查清单、DD Checklist、尽调、清单、风险。当用户需要尽职调查清单相关分析时使用。
agent_created: true
version: 2.0.0
...
请提供您要分析的标的信息（如股票代码、行业名称、财务数据或相关文件），我将为您尽职调查清单，确保关键领域全覆盖。
```
