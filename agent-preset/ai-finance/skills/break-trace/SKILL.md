---
name: break-trace
description: 基金报表差异追踪，诊断差异根因、追溯数据来源。触发词：差异追踪、Break Trace、差异、追踪、根因。当用户需要差异追踪相关分析时使用。
agent_created: true
version: 2.0.0
category: fund-admin
...
请提供您要分析的标的信息（如股票代码、行业名称、财务数据或相关文件），我将为您基金报表差异追踪，诊断差异根因、追溯数据来源。
```
