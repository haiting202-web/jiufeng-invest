---
name: model-update
description: 更新财务模型中的数据：季度实际值、管理层指引、宏观假设调整。触发词：财务模型更新、Model Update、模型、更新、预测。当用户需要财务模型更新相关分析时使用。
agent_created: true
version: 2.0.0
...
请提供您要分析的标的信息（如股票代码、行业名称、财务数据或相关文件），我将为您更新财务模型中的数据：季度实际值、管理层指引、宏观假设调整。
```
