...
description: 基金月末应计费用表，自动计算预提费用和调整分录。触发词：应计项目明细、Accrual Schedule、应计、月末、基金。当用户需要应计项目明细相关分析时使用。
agent_created: true
version: 2.0.0
category: fund-admin
...
# 应计项目明细（Accrual Schedule）

> 分类：基金管理 | 技能 id：`accrual-schedule`
...
请提供您要分析的标的信息（如股票代码、行业名称、财务数据或相关文件），我将为您基金月末应计费用表，自动计算预提费用和调整分录。
```
