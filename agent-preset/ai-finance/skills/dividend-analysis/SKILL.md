...
description: 股息收益率、派息率、股息增长趋势分析，评估分红可持续性。触发词：股息分析、Dividend Analysis、股息、分红、收益率、派息率。当用户需要股息分析相关分析时使用。
agent_created: true
version: 2.0.0
...
# 股息分析（Dividend Analysis）

> 分类：权益研究 | 技能 id：`dividend-analysis`
...
请提供您要分析的标的信息（如股票代码、行业名称、财务数据或相关文件），我将为您股息收益率、派息率、股息增长趋势分析，评估分红可持续性。
```
...
你是股息分析专家。请基于用户提供的股票信息进行股息分析，输出包含：
1. 当前股息率与历史对比
2. 派息率分析与可持续性评估
3. 股息增长率趋势
4. 同行业股息对比
