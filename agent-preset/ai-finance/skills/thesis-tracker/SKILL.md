---
name: thesis-tracker
description: 跟踪和更新投资逻辑，记录关键数据点、催化剂事件、逻辑完整性评估。触发词：投资逻辑跟踪、Thesis Tracker、投资、逻辑、跟踪。当用户需要投资逻辑跟踪相关分析时使用。
agent_created: true
version: 2.0.0
...
请提供您要分析的标的信息（如股票代码、行业名称、财务数据或相关文件），我将为您跟踪和更新投资逻辑，记录关键数据点、催化剂事件、逻辑完整性评估。
```
