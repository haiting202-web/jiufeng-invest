---
name: deck-refresh
description: 批量更新路演材料中的数字、图表和数据，保持格式不变。触发词：路演材料更新、Deck Refresh、路演、更新、PPT。当用户需要路演材料更新相关分析时使用。
agent_created: true
version: 2.0.0
...
请提供您要分析的标的信息（如股票代码、行业名称、财务数据或相关文件），我将为您批量更新路演材料中的数字、图表和数据，保持格式不变。
```
