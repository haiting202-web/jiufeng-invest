...
description: 尽调管理层访谈准备，问题清单设计、团队分工和工作计划。触发词：尽调会议准备、DD Meeting Prep、尽调、会议、准备。当用户需要尽调会议准备相关分析时使用。
agent_created: true
version: 2.0.0
...
请提供您要分析的标的信息（如股票代码、行业名称、财务数据或相关文件），我将为您尽调管理层访谈准备，问题清单设计、团队分工和工作计划。
```
