---
name: cim-builder
description: 保密信息备忘录，用于并购交易的公司介绍材料。触发词：信息备忘录制作、CIM Builder、CIM、并购、交易。当用户需要信息备忘录制作相关分析时使用。
agent_created: true
version: 2.0.0
...
请提供您要分析的标的信息（如股票代码、行业名称、财务数据或相关文件），我将为您保密信息备忘录，用于并购交易的公司介绍材料。
```
