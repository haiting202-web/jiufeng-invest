...
description: 投资收益分析，IRR、MOIC、DPI计算。触发词：投资收益分析、Returns Analysis、收益、IRR、回报。当用户需要投资收益分析相关分析时使用。
agent_created: true
version: 2.0.0
...
# 投资收益分析（Returns Analysis）

> 分类：私募股权 | 技能 id：`returns-analysis`
...
请提供您要分析的标的信息（如股票代码、行业名称、财务数据或相关文件），我将为您投资收益分析，IRR、MOIC、DPI计算。
```
