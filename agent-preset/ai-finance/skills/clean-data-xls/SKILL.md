---
name: clean-data-xls
description: Excel数据清洗、格式标准化、异常值处理、数据验证。触发词：Excel数据整理、Data Cleaning、数据、清洗、Excel。当用户需要Excel数据整理相关分析时使用。
agent_created: true
version: 2.0.0
...
# Excel数据整理（Data Cleaning）

> 分类：财务分析 | 技能 id：`clean-data-xls`
...
请提供您要分析的标的信息（如股票代码、行业名称、财务数据或相关文件），我将为您Excel数据清洗、格式标准化、异常值处理、数据验证。
```
