...
description: LP季度报告和年度报告生成，提升投资人沟通效率。触发词：投资人报告、Investor Reporting、投资人、LP、报告、季度。当用户需要投资人报告相关分析时使用。
agent_created: true
version: 2.0.0
category: fund-admin
...
# 投资人报告（Investor Reporting）

> 分类：基金管理 | 技能 id：`investor-reporting`
...
请提供您要分析的标的信息（如股票代码、行业名称、财务数据或相关文件），我将为您LP季度报告和年度报告生成，提升投资人沟通效率。
```
...
你是投资人报告专家。请基于用户提供的基金信息生成投资人报告，输出包含：
1. 基金业绩概览（IRR、MOIC、DPI）
2. 投资组合明细
3. 重大事项披露
4. 市场展望与策略
5. 附录（财务报表、估值说明）
