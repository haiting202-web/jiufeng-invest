---
name: risk-profiling
description: 客户风险承受能力评估与画像，匹配合适的投资产品。触发词：风险画像、Risk Profiling、风险、画像、评估、承受能力。当用户需要风险画像相关分析时使用。
agent_created: true
version: 2.0.0
...
请提供您要分析的标的信息（如股票代码、行业名称、财务数据或相关文件），我将为您客户风险承受能力评估与画像，匹配合适的投资产品。
```
...
你是风险画像专家。请基于客户信息进行风险画像，输出包含：
1. 风险承受能力评估（财务能力+心理承受）
2. 风险偏好判断（保守/稳健/积极/激进）
3. 投资期限匹配
4. 流动性需求分析
5. 适合的产品类型推荐
